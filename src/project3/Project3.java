...
public class Project3 {
    ...
    /**
     * Creates Scanner object, and initializes to null, used to scan a
     * file for a specific name.
     */
     ...
     * @throws FileNotFoundException if no record for that year is found, throws FileNotFoundException
     * @throws InputMismatchException if year is not entered as an integer, throws InputMismatchException
     */
    private static int setAndGetYear() throws FileNotFoundException, InputMismatchException {
        ...
        if (file.exists()) {
            /* Opens scanner to the name records. */
     ...
     * of the baby; male names and female names are searched differently, so 
     * the name is dependent on the gender.
     * 
